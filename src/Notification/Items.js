export const SliderData = [
...

    {
        id: 1,
        index:1,
        text: 'Create obstacles! Click on cells to add walls or use the "Create Maze" button to generate a maze pattern.',
        class: 'text-box'
    },
    ...
    },
    {
        id: 3, 
        index: 3,
        text: 'Select an algorithm! The mouse has four different strategies to search for the cheese and find the shortest path to it.',
        class: 'text-box'
    },
    {
        id: 4,
    ...
    },
    {
        id: 7,
        index: 7,
        text: 'BFS (Breadth-First) Search -> This search algorithm is unweighted. Searches in a predefined manner. Guarantees the shortest path!',
        class: 'bfs-slide'
    ...
    },
    {
        id: 8,
        index: 8,
        text: 'DFS (Depth First) Search -> This search algorithm is unweighted. Searches in a predefined manner. DOES NOT guarantee the shortest path!',
        class: 'dfs-slide'
